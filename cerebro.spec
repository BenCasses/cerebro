...
BuildRoot: %{_tmppath}/cerebro-1.21
...
%define _with_gendersllnl_ion              --with-gendersllnl-ion
...
%package clusterlist-gendersllnl-ion
Summary: clusterlist gendersllnl-ion module
Group: System Environment/Base
Requires: cerebro
Requires: gendersllnl
%description clusterlist-gendersllnl-ion
Gendersllnl-Ion module
...
%package monitor-bootlog
Summary: bootlog module
Group: System Environment/Base
Requires: cerebro
Requires: mysql-devel
%description monitor-bootlog
...
%if %{?_with_gendersllnl_ion:1}%{!?_with_gendersllnl_ion:0}
%files clusterlist-gendersllnl-ion
%defattr(-,root,root)
%{_libdir}/cerebro/*cerebro_clusterlist_gendersllnl_ion.*
%endif
