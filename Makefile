...
pkgdatadir = $(datadir)/cerebro
pkgincludedir = $(includedir)/cerebro
pkglibdir = $(libdir)/cerebro
pkglibexecdir = $(libexecdir)/cerebro
...
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog \
	...
	$(top_srcdir)/config/config.h.in $(srcdir)/cerebro.spec.in \
	$(top_srcdir)/src/libs/include/cerebro/cerebro_metric_control_protocol.h.in \
...
CONFIG_CLEAN_FILES = cerebro.spec \
...
CTAGS = ctags
CSCOPE = cscope
DIST_SUBDIRS = libltdl etc man src
...
CEREBRO_MODULE_DIR = /usr/local/lib/cerebro
...
LD = /usr/tce/bin/ld -m elf_x86_64
LDFLAGS = 
LIBADD_DL = -ldl 
LIBADD_DLD_LINK = 
LIBADD_DLOPEN = -ldl
LIBADD_SHL_LOAD = 
LIBCEREBRO_ERROR_VERSION_INFO = 0:0:0
LIBCEREBRO_VERSION_INFO = 1:1:0
LIBLTDL = -lltdl
LIBOBJS = 
LIBS = -ldl 
...
MANPAGE_UPDOWN = 1
METRIC_CONTROL_PATH = "/usr/local/var/run/cerebro_metric_control"
...
SET_MAKE = 
SHELL = /bin/sh
SLURM_STATE_CONTROL_PATH = /usr/local/lib/cerebro/cerebro_metric_slurm_state
STRIP = strip
VERSION = 1.21
WITH_STATIC_MODULES = 
abs_builddir = /g/g0/casses1/cerebro/bitbucket/cerebro
abs_srcdir = /g/g0/casses1/cerebro/bitbucket/cerebro
abs_top_builddir = /g/g0/casses1/cerebro/bitbucket/cerebro
abs_top_srcdir = /g/g0/casses1/cerebro/bitbucket/cerebro
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /g/g0/casses1/cerebro/bitbucket/cerebro/config/install-sh
...
EXTRA_DIST = autogen.sh DISCLAIMER DISCLAIMER.UC META cerebro.spec.in cerebro.spec
all: all-recursive
...
cerebro.spec: $(top_builddir)/config.status $(srcdir)/cerebro.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
src/libs/include/cerebro/cerebro_metric_control_protocol.h: $(top_builddir)/config.status $(top_srcdir)/src/libs/include/cerebro/cerebro_metric_control_protocol.h.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
